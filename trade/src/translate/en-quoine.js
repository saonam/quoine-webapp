...
export default {
  ...
  "wdr-address": {
    ...
    "edit-success": "Your address has been editted successfully.",
    ...
    "confirm-dismiss": "Dismiss",
    "confirm-success": "Verify successfully. You can now go back to Withdrawal",
  },
  "wdr-address-error": {
    "address-not-in-whitelist": "Address is not in whitelist",
    "address-not-unique": "Address is not unique",
    "address-invalid": "Address is invalid",
    "already-confirmed": "Address is already confirmed",
    "verification-failed": "This authentication code is invalid.",
