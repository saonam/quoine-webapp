...
export default {
  ...
  "wdr-address": {
    ...
    "add-action": "添加新地址",
    "edit-success": "地址修改成功。",
    "add-success": "地址修改成功，请确认验证",
    "confirmation-token-input": "确认码",
    "confirmation-token-description": "请查收您的邮件并输入邮件内的确认验证码。验证码将在30分钟后失效。未被验证的地址将被自动移除。",
    "address": "地址",
    "remove-confirm": "移除",
    "confirm-action": "确认",
    "auth-code": "验证码",
    ...
    "confirm-submit": "确认",
    "confirm-dismiss": "取消",
    "confirm-success": "确认成功，请返回取款界面",
  },
  "wdr-address-error": {
    "address-not-in-whitelist": "地址不在白名单",
    "address-not-unique": "地址并非唯一",
    "address-invalid": "地址无效",
    "already-confirmed": "地址已被确认",
    "verification-failed": "此授权码无效",
    "confirmation-token-is-invalid": "确认验证码无效",
    "confirmation-period-is-expired": "确认已过期",
    "token-is-invalid": "此验证码无效",
  },
  // ===
  "volume": {
