...
export default {
  ...
  "wdr-address": {
    ...
    "add-action": "添加新地址",
    "edit-success": "地址修改成功",
    "add-success": "地址修改成功，請確認驗證",
    "confirmation-token-input": "確認碼",
    "confirmation-token-description": "請查收您的郵件並輸入郵件內的確認驗證碼。驗證碼將在30分鐘後失效。未被驗證的地址將被自動移除。",
    "address": "地址",
    "remove-confirm": "移除",
    "confirm-action": "確認",
    "auth-code": "驗證碼",
    ...
    "confirm-submit": "確認",
    "confirm-dismiss": "取消",
    "confirm-success": "確認成功，請返回取款界面",
  },
  "wdr-address-error": {
    "address-not-in-whitelist": "地址不在白名單",
    "address-not-unique": "地址並非唯一",
    "address-invalid": "地址無效",
    "already-confirmed": "址已被確認",
    "verification-failed": "此授權碼無效",
    "confirmation-token-is-invalid": "確認驗證碼無效",
    "confirmation-period-is-expired": "確認已過期",
    "token-is-invalid": "此驗證碼無效",
  },
  // ===
  "volume": {
