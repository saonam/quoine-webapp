...
export default {
  ...
  "order": {
    ...
    // ===
    "direction": "両建設定",
    "direction-help": "両建なし：建玉と反対ポジションの注文は発注できないモード<br />両建あり：建玉と反対ポジションの注文が発注できるモード（証拠金は双方に必要となります）<br />ネットアウト：約定日時が古い反対ポジションから順にネッティング決済されるモード",
  ...
  "position": {
    ...
    "quantity-open": "数量",
    // ===
    "int-total": "レバレッジ手数料合計",
    "interest-total": "レバレッジ手数料合計",
    // ===
    "created-at": "約定日時",
    "fee": "取引手数料",
    "id": "約定番号",
  ...
  "position-error": {
    ...
    "close-quantity-larger-than-open-quantity": "非開示注文数量は注文数量以下を入力可能です。",
  ...
  "fund-bank": {
    ...
    "help-2": "②みんなのビットコイン銀行口座にお振込",
    "help-2-note": "振込名義は「入金ID お客様氏名」にてお振込ください。",
    // ===
    "success": "入金情報をご作成いただきありがとうございます。この入金情報の入金IDは{{id}}です。",
    // ===
    "submit": "送信",
    "open": "入金情報を作成する",
    "dismiss": "閉じる",
    // ===
    "not-support": "現在、入出金は日本円・BTC・ETHでのみ受け付けております。",
  },
  "fund-cash": {
