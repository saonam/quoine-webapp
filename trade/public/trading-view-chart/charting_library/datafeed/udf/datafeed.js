...
Datafeeds.UDFCompatibleDatafeed = function({ vendor, datafeedURL, historyUrl, updateFrequency, symbol, pricescale }) {
  this._vendor = vendor;
...
Datafeeds.UDFCompatibleDatafeed.prototype.resolveSymbol = function(symbolName, onSymbolResolvedCallback, onResolveErrorCallback) {
  ...
  setTimeout(function() {
    onResultReady({
      "name": that._symbol,
      "exchange-traded": that._vendor,
      "exchange-listed": that._vendor,
      "timezone": "Asia/Tokyo",
      "minmov": 1,
      "minmov2": 0,
      "pricescale": that._pricescale,
      "session": "24x7",
      "has_intraday": true,
      "has_empty_bars": true,
