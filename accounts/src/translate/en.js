...
export default {
  ...
  "sign-up": {
    ...
    "input-password-hint": "Password must have at least 8 characters and contain at least 1 lowercase letter, 1 uppercase letter, and 1 number.",
    "input-first-name": "First Name",
    "input-last-name": "Last Name",
    "input-business-name": "Business Name",
    "input-business-type": "Business Type",
    // step 3
